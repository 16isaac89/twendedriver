...
export const GET_TODAY_EARNINGS = 'get_today_earning'
export const GET_EARNINGS = 'get_earnings'
export const AUTH_SENDING_FAILED = 'sending_failed'

export const OLD_PASSWORD = 'old_password'
export const NEW_PASSWORD = 'new_password'
export const CONFIRM_PASSWORD = 'confirm_password'
export const PASSWORD_EDITED = 'password_edited'
export const CLOSE_ORDER_DETAILSMODAL = 'close_order_detailsmodal'
